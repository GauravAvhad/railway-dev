...
public class SecurityConfig {
    ...
    @Autowired
    private UserDetailsService userDetailsService; // bean of CustomerUserDetailsService will get injected by spring container as we have implemented UserDetailsService
    @Autowired
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Customizer is a functional Interface so we can use Lambda
